<template>
  <div class="orderExamine">
    ...
    <div class="orderExamine-xg" style="padding-bottom: 2.5rem;">
    ...
    <div class="order-manage-button">
      <van-button type="primary" size="large" class="order-manage-button-item" @click="djBtn()">审核</van-button>
    </div>
        ...
        Dialog.confirm({
          ...
          .then(() => {
            Notify({
              ...
              duration: 1000,
              onOpened() {
               _this.$router.push({path:"/orderManage",query:{id:2}})
              }
            });
          })
          .catch(() => {
